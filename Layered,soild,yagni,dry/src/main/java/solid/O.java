...
public class O {
 ...
 class EventHandler extends O {
	    ...
	    public void changeDrivingMode(final DrivingMode drivingMode){
	        ...
	        vehicle.setSuspensionHeight(drivingMode.getSuspensionHegiht());
	 ...
	 abstract class Comfort implements DrivingMode {
	   ...
	   // @Override
	    public int getSuspensionHeight() {
		 ...
		 abstract class Sport implements DrivingMode {
		   ...
		   //@Override
		    ...
		    public int getSuspensionHeight() {
			 ...
			 abstract class Economy implements DrivingMode{
